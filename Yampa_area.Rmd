...
# Burro Mountain	378 
*NSCE- Original, Bias- Morrisey* 7/11/2002 so, ORIGINAL.
**Morrisey is marked as having the smallest bias, but the sheet says original is smaller.** 
...
#### summer MK & SS for 378 (non-corrected)

```{r 378 sd summer mk & ss non corrected}
...
#### winter MK & SS for 378 (non-corrected)

```{r 378 sd winter mk & ss non corrected}
...
#### summer MK & SS 378 (corrected)

```{r 378 summer sd mk & ss adjusted}
...
#### winter MK & SS 378 (corrected)

```{r 378 winter sd mk & ss adjusted}
...
#### spring MK & SS for 378 (non-corrected)

```{r 378 sd spring mk & ss non corrected}
...
## **Fall is split each water year in the middle of the season. This analysis splits the fall season between the preceeding water year and the subsequent water year.**  

```{r 378 SD fall NOT CORRECTED}
...
#### fall MK & SS for 378 (non-corrected)

```{r 378 sd fall mk & ss non corrected}
...
#### spring MK & SS 378 (corrected)

```{r 378 spring sd mk & ss adjusted}
...
#### fall MK & SS 378 (corrected)

```{r 378 fall sd mk & ss adjusted}
...
#### summer MK & SS for 408 (non-corrected)

```{r 408 sd summer mk & ss non corrected}
...
#### winter MK & SS for 408 (non-corrected)

```{r 408 sd winter mk & ss non corrected}
...
#### summer MK & SS 408 (corrected)

```{r 408 summer sd mk & ss adjusted}
...
#### winter MK & SS 408 (corrected)

```{r 408 winter sd mk & ss adjusted}
...
#### spring MK & SS for 408 (non-corrected)

```{r 408 sd spring mk & ss non corrected}
...
#### fall MK & SS for 408 (non-corrected)

```{r 408 sd fall mk & ss non corrected}
...
#### spring MK & SS 408 (corrected)

```{r 408 spring sd mk & ss adjusted}
...
#### fall MK & SS 408 (corrected)

```{r 408 fall sd mk & ss adjusted}
...
#### summer MK & SS for 409 (non-corrected)

```{r 409 sd summer mk & ss non corrected}
...
#### winter MK & SS for 409 (non-corrected)

```{r 409 sd winter mk & ss non corrected}
...
#### summer MK & SS 409 (corrected)

```{r 409 summer sd mk & ss adjusted}
...
#### winter MK & SS 409 (corrected)

```{r 409 winter sd mk & ss adjusted}
...
#### spring MK & SS for 409 (non-corrected)

```{r 409 sd spring mk & ss non corrected}
...
#### fall MK & SS for 409 (non-corrected)

```{r 409 sd fall mk & ss non corrected}
...
#### spring MK & SS 409 (corrected)

```{r 409 spring sd mk & ss adjusted}
...
#### fall MK & SS 409 (corrected)

```{r 409 fall sd mk & ss adjusted}
...
#### summer MK & SS for 426 (non-corrected)

```{r 426 sd summer mk & ss non corrected}
...
#### winter MK & SS for 426 (non-corrected)

```{r 426 sd winter mk & ss non corrected}
...
#### summer MK & SS 426 (corrected)

```{r 426 summer sd mk & ss adjusted}
...
#### winter MK & SS 426 (corrected)

```{r 426 winter sd mk & ss adjusted}
...
#### spring MK & SS for 426 (non-corrected)

```{r 426 sd spring mk & ss non corrected}
...
#### fall MK & SS for 426 (non-corrected)

```{r 426 sd fall mk & ss non corrected}
...
#### spring MK & SS 426 (corrected)

```{r 426 spring sd mk & ss adjusted}
...
#### fall MK & SS 426 (corrected)

```{r 426 fall sd mk & ss adjusted}
...
#### summer MK & SS for 457 (non-corrected)

```{r 457 sd summer mk & ss non corrected}
...
#### winter MK & SS for 457 (non-corrected)

```{r 457 sd winter mk & ss non corrected}
...
#### summer MK & SS 457 (corrected)

```{r 457 summer sd mk & ss adjusted}
...
#### winter MK & SS 457 (corrected)

```{r 457 winter sd mk & ss adjusted}
...
#### spring MK & SS for 457 (non-corrected)

```{r 457 sd spring mk & ss non corrected}
...
#### fall MK & SS for 457 (non-corrected)

```{r 457 sd fall mk & ss non corrected}
...
#### spring MK & SS 457 (corrected)

```{r 457 spring sd mk & ss adjusted}
...
#### fall MK & SS 457 (corrected)

```{r 457 fall sd mk & ss adjusted}
...
#### summer MK & SS for 467 (non-corrected)

```{r 467 sd summer mk & ss non corrected}
...
#### winter MK & SS for 467 (non-corrected)

```{r 467 sd winter mk & ss non corrected}
...
#### summer MK & SS 467 (corrected)

```{r 467 summer sd mk & ss adjusted}
...
#### winter MK & SS 467 (corrected)

```{r 467 winter sd mk & ss adjusted}
...
#### spring MK & SS for 467 (non-corrected)

```{r 467 sd spring mk & ss non corrected}
...
#### fall MK & SS for 467 (non-corrected)

```{r 467 sd fall mk & ss non corrected}
...
#### spring MK & SS 467 (corrected)

```{r 467 spring sd mk & ss adjusted}
...
#### fall MK & SS 467 (corrected)

```{r 467 fall sd mk & ss adjusted}
...
#### summer MK & SS for 607 (non-corrected)

```{r 607 sd summer mk & ss non corrected}
...
#### winter MK & SS for 607 (non-corrected)

```{r 607 sd winter mk & ss non corrected}
...
#### summer MK & SS 607 (corrected)

```{r 607 summer sd mk & ss adjusted}
...
#### winter MK & SS 607 (corrected)

```{r 607 winter sd mk & ss adjusted}
...
#### spring MK & SS for 607 (non-corrected)

```{r 607 sd spring mk & ss non corrected}
...
#### fall MK & SS for 607 (non-corrected)

```{r 607 sd fall mk & ss non corrected}
...
#### spring MK & SS 607 (corrected)

```{r 607 spring sd mk & ss adjusted}
...
#### fall MK & SS 607 (corrected)

```{r 607 fall sd mk & ss adjusted}
...
#### summer MK & SS for 709 (non-corrected)

```{r 709 sd summer mk & ss non corrected}
...
#### winter MK & SS for 709 (non-corrected)

```{r 709 sd winter mk & ss non corrected}
...
#### summer MK & SS 709 (corrected)

```{r 709 summer sd mk & ss adjusted}
...
#### winter MK & SS 709 (corrected)

```{r 709 winter sd mk & ss adjusted}
...
#### spring MK & SS for 709 (non-corrected)

```{r 709 sd spring mk & ss non corrected}
...
#### fall MK & SS for 709 (non-corrected)

```{r 709 sd fall mk & ss non corrected}
...
#### spring MK & SS 709 (corrected)

```{r 709 spring sd mk & ss adjusted}
...
#### fall MK & SS 709 (corrected)

```{r 709 fall sd mk & ss adjusted}
...
#### summer MK & SS for 717 (non-corrected)

```{r 717 sd summer mk & ss non corrected}
...
#### winter MK & SS for 717 (non-corrected)

```{r 717 sd winter mk & ss non corrected}
...
#### summer MK & SS 717 (corrected)

```{r 717 summer sd mk & ss adjusted}
...
#### winter MK & SS 717 (corrected)

```{r 717 winter sd mk & ss adjusted}
...
#### spring MK & SS for 717 (non-corrected)

```{r 717 sd spring mk & ss non corrected}
...
#### fall MK & SS for 717 (non-corrected)

```{r 717 sd fall mk & ss non corrected}
...
#### spring MK & SS 717 (corrected)

```{r 717 spring sd mk & ss adjusted}
...
#### fall MK & SS 717 (corrected)

```{r 717 fall sd mk & ss adjusted}
...
#### summer MK & SS for 825 (non-corrected)

```{r 825 sd summer mk & ss non corrected}
...
#### winter MK & SS for 825 (non-corrected)

```{r 825 sd winter mk & ss non corrected}
...
#### summer MK & SS 825 (corrected)

```{r 825 summer sd mk & ss adjusted}
...
#### winter MK & SS 825 (corrected)

```{r 825 winter sd mk & ss adjusted}
...
#### spring MK & SS for 825 (non-corrected)

```{r 825 sd spring mk & ss non corrected}
...
#### fall MK & SS for 825 (non-corrected)

```{r 825 sd fall mk & ss non corrected}
...
#### spring MK & SS 825 (corrected)

```{r 825 spring sd mk & ss adjusted}
...
#### fall MK & SS 825 (corrected)

```{r 825 fall sd mk & ss adjusted}
...
#### summer MK & SS for 827 (non-corrected)

```{r 827 sd summer mk & ss non corrected}
...
#### winter MK & SS for 827 (non-corrected)

```{r 827 sd winter mk & ss non corrected}
...
#### summer MK & SS 827 (corrected)

```{r 827 summer sd mk & ss adjusted}
...
#### winter MK & SS 827 (corrected)

```{r 827 winter sd mk & ss adjusted}
...
#### spring MK & SS for 827 (non-corrected)

```{r 827 sd spring mk & ss non corrected}
...
#### fall MK & SS for 827 (non-corrected)

```{r 827 sd fall mk & ss non corrected}
...
#### spring MK & SS 827 (corrected)

```{r 827 spring sd mk & ss adjusted}
...
#### fall MK & SS 827 (corrected)

```{r 827 fall sd mk & ss adjusted}
